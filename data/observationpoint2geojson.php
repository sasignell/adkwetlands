...
$sql = "SELECT a.name,b.point_number,b.lat,b.lng, 
public.ST_AsGeoJSON(public.ST_Transform(b.geom,4326),6) as geojson
   FROM adkwetlands.site AS a JOIN adkwetlands.observationpoint AS B ON a.site_pk=b.site_fk";
...
$f = fopen("observationpoint.geojson", "w"); 
