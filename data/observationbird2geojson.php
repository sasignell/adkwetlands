...
$sql = "SELECT DISTINCT a.name,b.point_number,b.lat,b.lng, c.*, 'bird' AS surveytype,d.observation_fk,public.ST_AsGeoJSON(public.ST_Transform(b.geom,4326),6) as geojson
FROM adkwetlands.observationpoint AS b JOIN adkwetlands.site AS a ON a.site_pk=b.site_fk
                      JOIN adkwetlands.observation AS c ON c.observationpoint_fk=b.observationpoint_pk
                        JOIN adkwetlands.bird AS d ON c.observation_pk=d.observation_fk";
...
$f = fopen("observationbird.geojson", "w"); 
